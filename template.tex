...
\documentclass[pagenumbers]{stabs2021}

% Leave option pagenumbers in to facilitate review. Remove it for
% final upload after acceptation.

% The class is based on the KOMA-Script article class and provides
% therefore all the features that this class provides. Documentation
